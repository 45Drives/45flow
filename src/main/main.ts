...
import { server, unwrap, IPCRouter } from '@45drives/houston-common-lib';
...
import { registerHttpUploadHandlers } from './transfers/http-upload';
import { registerTranscodeOutputUploadHandlers } from './transfers/transcode-output-upload';
...
// ── HTTP chunked upload ──────────────────────────────────────────────────────
registerHttpUploadHandlers()
registerTranscodeOutputUploadHandlers()
...
// ── Cleanup: remove a specific temp directory ────────────────────────────────
